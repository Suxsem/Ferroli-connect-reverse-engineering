...
import com.github.barteksc.pdfviewer.C0955R;
...
public class DefaultScrollHandle extends RelativeLayout implements ScrollHandle {
    ...
    public void setupLayout(PDFView pDFView) {
        ...
        if (!pDFView.isSwipeVertical()) {
            if (this.inverted) {
                i = 10;
                drawable = ContextCompat.getDrawable(this.context, C0955R.C0956drawable.default_scroll_handle_top);
            } else {
                i = 12;
                drawable = ContextCompat.getDrawable(this.context, C0955R.C0956drawable.default_scroll_handle_bottom);
            }
            i2 = 40;
            i3 = 65;
        } else if (this.inverted) {
            i = 9;
            drawable = ContextCompat.getDrawable(this.context, C0955R.C0956drawable.default_scroll_handle_left);
        } else {
            i = 11;
            drawable = ContextCompat.getDrawable(this.context, C0955R.C0956drawable.default_scroll_handle_right);
        }
