...
public class C1469a {
    /* renamed from: a */
    public static void m2663a(String str) {
    ...
    /* renamed from: a */
    public static void m2664a(String str, int i, String str2, int i2) {
    ...
    /* renamed from: a */
    public static void m2665a(Map<String, Object> map, int i, int i2) {
        if (map != null) {
            C1340e.m2032a().mo14703a((C1575h) new C1470b((long) (i == 1 ? 120000 : i == 2 ? 180000 : RestConstants.G_MAX_CONNECTION_TIME_OUT), map, i2, i));
        }
    }
}
