...
public class C1254c extends C1253b {

    /* renamed from: a */
    private static final String f1880a = (C1233j.f1818a + "_BindAliasResultAction");

    /* renamed from: a */
    public boolean mo14470a(Object obj, JSONObject jSONObject) {
        C1179b.m1354a(f1880a + "|bind alias result resp data = " + jSONObject);
        if (jSONObject == null) {
            return true;
        }
        try {
            ...
            C1238a.m1630a().mo14459b(jSONObject.getString("sn"), jSONObject.getString("result"));
            return true;
        } catch (Exception e) {
            C1179b.m1354a(f1880a + "|" + e.toString());
            return true;
        }
    }
}
