    ...
    public void onBindViewHolder(K k, int i) {
        ...
        if (this.mItemTouchHelper != null && this.itemDragEnabled && itemViewType != 546 && itemViewType != 273 && itemViewType != 1365 && itemViewType != 819) {
            ...
            if (i2 != 0) {
                ...
                if (view != null) {
                    view.setTag(C0934R.C0936id.BaseQuickAdapter_viewholder_support, k);
                ...
                k.itemView.setTag(C0934R.C0936id.BaseQuickAdapter_viewholder_support, k);
        ...
        if (this.mDragOnLongPress) {
            ...
            this.mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                public boolean onLongClick(View view) {
                    ...
                    BaseItemDraggableAdapter.this.mItemTouchHelper.startDrag((RecyclerView.ViewHolder) view.getTag(C0934R.C0936id.BaseQuickAdapter_viewholder_support));
                    return true;
                }
            };
            return;
