...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo12890id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo12890id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo12890id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo12890id = 9)
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getScopes", mo12890id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo12890id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo12890id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo12890id = 5)
    ...
    GoogleSignInOptions(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(mo12893id = 3) Account account, @SafeParcelable.Param(mo12893id = 4) boolean z, @SafeParcelable.Param(mo12893id = 5) boolean z2, @SafeParcelable.Param(mo12893id = 6) boolean z3, @SafeParcelable.Param(mo12893id = 7) String str, @SafeParcelable.Param(mo12893id = 8) String str2, @SafeParcelable.Param(mo12893id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
