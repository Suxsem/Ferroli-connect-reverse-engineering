...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", mo12890id = 3)
    private Bundle mBundle;
    @SafeParcelable.Field(getter = "getType", mo12890id = 2)
    private int mType;
    @SafeParcelable.VersionField(mo12896id = 1)
    private final int versionCode;

    @SafeParcelable.Constructor
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) int i2, @SafeParcelable.Param(mo12893id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
