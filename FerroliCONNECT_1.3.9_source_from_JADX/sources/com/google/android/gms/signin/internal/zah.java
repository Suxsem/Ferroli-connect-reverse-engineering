...
public final class zah extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountRequest", mo12890id = 2)
    private final ResolveAccountRequest zasa;

    @SafeParcelable.Constructor
    zah(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.zale = i;
