...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo12890id = 2)
    private final ConnectionResult zadh;
    @SafeParcelable.VersionField(mo12896id = 1)
    private final int zale;
    @SafeParcelable.Field(getter = "getResolveAccountResponse", mo12890id = 3)
    private final ResolveAccountResponse zasb;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(mo12893id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zale = i;
