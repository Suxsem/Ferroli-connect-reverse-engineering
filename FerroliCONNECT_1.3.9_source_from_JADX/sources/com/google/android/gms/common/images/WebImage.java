...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWidth", mo12890id = 3)
    private final int zand;
    @SafeParcelable.Field(getter = "getHeight", mo12890id = 4)
    private final int zane;
    @SafeParcelable.Field(getter = "getUrl", mo12890id = 2)
    private final Uri zanf;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) Uri uri, @SafeParcelable.Param(mo12893id = 3) int i2, @SafeParcelable.Param(mo12893id = 4) int i3) {
        this.zale = i;
        this.zanf = uri;
        this.zand = i2;
        this.zane = i3;
