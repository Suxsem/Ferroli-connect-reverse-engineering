...
public final class StringToIntConverter extends AbstractSafeParcelable implements FastJsonResponse.FieldConverter<String, Integer> {
    ...
    @SafeParcelable.Field(getter = "getSerializedMap", mo12890id = 2)
    private final ArrayList<zaa> zapn;

    @SafeParcelable.Constructor
    StringToIntConverter(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) ArrayList<zaa> arrayList) {
        this.zale = i;
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Constructor
        zaa(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) String str, @SafeParcelable.Param(mo12893id = 3) int i2) {
            this.versionCode = i;
            this.zapo = str;
            this.zapp = i2;
        }
