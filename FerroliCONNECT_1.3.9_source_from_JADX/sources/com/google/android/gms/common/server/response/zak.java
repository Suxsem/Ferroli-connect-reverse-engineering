...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo12890id = 2)
    private final ArrayList<zal> zaqv;
    @SafeParcelable.Field(getter = "getRootClassName", mo12890id = 3)
    private final String zaqw;

    @SafeParcelable.Constructor
    zak(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) ArrayList<zal> arrayList, @SafeParcelable.Param(mo12893id = 3) String str) {
        this.zale = i;
        this.zaqv = null;
