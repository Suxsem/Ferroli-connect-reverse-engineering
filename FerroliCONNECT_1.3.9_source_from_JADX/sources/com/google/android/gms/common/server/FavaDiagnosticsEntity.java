...
public class FavaDiagnosticsEntity extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public FavaDiagnosticsEntity(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) String str, @SafeParcelable.Param(mo12893id = 3) int i2) {
        this.zale = i;
        this.zapi = str;
        this.zapj = i2;
    }
