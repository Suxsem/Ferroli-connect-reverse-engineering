...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", mo12890id = 2)
    private final StringToIntConverter zapk;

    @SafeParcelable.Constructor
    zaa(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) StringToIntConverter stringToIntConverter) {
        this.zale = i;
