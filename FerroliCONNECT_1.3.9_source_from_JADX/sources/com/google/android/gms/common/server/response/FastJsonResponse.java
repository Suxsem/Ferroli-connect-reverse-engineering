...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.VersionField(getter = "getVersionCode", mo12896id = 1)
        private final int zale;
        @SafeParcelable.Field(getter = "getTypeIn", mo12890id = 2)
        protected final int zapq;
        @SafeParcelable.Field(getter = "isTypeInArray", mo12890id = 3)
        protected final boolean zapr;
        @SafeParcelable.Field(getter = "getTypeOut", mo12890id = 4)
        protected final int zaps;
        @SafeParcelable.Field(getter = "isTypeOutArray", mo12890id = 5)
        protected final boolean zapt;
        @SafeParcelable.Field(getter = "getOutputFieldName", mo12890id = 6)
        protected final String zapu;
        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo12890id = 7)
        protected final int zapv;
        protected final Class<? extends FastJsonResponse> zapw;
        @SafeParcelable.Field(getter = "getConcreteTypeName", mo12890id = 8)
        private final String zapx;
        private zak zapy;
        /* access modifiers changed from: private */
        @SafeParcelable.Field(getter = "getWrappedConverter", mo12890id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zapz;

        @SafeParcelable.Constructor
        Field(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) int i2, @SafeParcelable.Param(mo12893id = 3) boolean z, @SafeParcelable.Param(mo12893id = 4) int i3, @SafeParcelable.Param(mo12893id = 5) boolean z2, @SafeParcelable.Param(mo12893id = 6) String str, @SafeParcelable.Param(mo12893id = 7) int i4, @SafeParcelable.Param(mo12893id = 8) String str2, @SafeParcelable.Param(mo12893id = 9) zaa zaa) {
            this.zale = i;
            this.zapq = i2;
            this.zapr = z;
            this.zaps = i3;
