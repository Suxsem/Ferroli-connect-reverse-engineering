...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", mo12890id = 1)
    private final int zzh;
    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", mo12890id = 3)
    private final PendingIntent zzi;
    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", mo12890id = 2)
    private final String zzj;

    @SafeParcelable.Constructor
    @KeepForSdk
    Status(@SafeParcelable.Param(mo12893id = 1000) int i, @SafeParcelable.Param(mo12893id = 1) int i2, @Nullable @SafeParcelable.Param(mo12893id = 2) String str, @Nullable @SafeParcelable.Param(mo12893id = 3) PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
