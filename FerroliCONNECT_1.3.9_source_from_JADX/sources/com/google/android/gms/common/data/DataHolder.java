...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(mo12896id = 1000)
    private final int zale;
    @SafeParcelable.Field(getter = "getColumns", mo12890id = 1)
    private final String[] zalp;
    private Bundle zalq;
    @SafeParcelable.Field(getter = "getWindows", mo12890id = 2)
    private final CursorWindow[] zalr;
    @SafeParcelable.Field(getter = "getStatusCode", mo12890id = 3)
    private final int zals;
    @SafeParcelable.Field(getter = "getMetadata", mo12890id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo12893id = 1000) int i, @SafeParcelable.Param(mo12893id = 1) String[] strArr, @SafeParcelable.Param(mo12893id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo12893id = 3) int i2, @SafeParcelable.Param(mo12893id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i;
        this.zalp = strArr;
