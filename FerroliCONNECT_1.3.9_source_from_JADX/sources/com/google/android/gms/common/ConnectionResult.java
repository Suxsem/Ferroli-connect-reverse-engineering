...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo12890id = 2)
    private final int zzh;
    @SafeParcelable.Field(getter = "getResolution", mo12890id = 3)
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", mo12890id = 4)
    private final String zzj;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo12893id = 1) int i, @SafeParcelable.Param(mo12893id = 2) int i2, @SafeParcelable.Param(mo12893id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo12893id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzh)).add("resolution", this.zzi).add(Constants.SHARED_MESSAGE_ID_FILE, this.zzj).toString();
    }
