...
public class FirebaseInstanceId {
    ...
    public Task<InstanceIdResult> getInstanceId() {
        return zza(zzam.zza(this.zzau), Constraint.ANY_ROLE);
    }
    ...
    public final zzaw zzk() {
        return zzb(zzam.zza(this.zzau), Constraint.ANY_ROLE);
    }
    ...
    public final String zzl() throws IOException {
        return getToken(zzam.zza(this.zzau), Constraint.ANY_ROLE);
    }

    private final <T> T zza(Task<T> task) throws IOException {
        try {
            return Tasks.await(task, GTIntentService.WAIT_TIME, TimeUnit.MILLISECONDS);
    ...
    private static String zzd(String str) {
        return (str.isEmpty() || str.equalsIgnoreCase("fcm") || str.equalsIgnoreCase(AgooConstants.MESSAGE_SYSTEM_SOURCE_GCM)) ? Constraint.ANY_ROLE : str;
    }
