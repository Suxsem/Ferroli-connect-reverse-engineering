...
public final class zza {
    ...
    public final zzc zzf(Bundle bundle) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this.zzag, zzm(zza(bundle, "gcm.n.android_channel_id")));
    ...
    private final int zzk(String str) {
        if (!TextUtils.isEmpty(str)) {
            Resources resources = this.zzag.getResources();
            int identifier = resources.getIdentifier(str, CustomNotificationBuilder.NOTIFICATION_ICON_RES_TYPE, this.zzdu);
