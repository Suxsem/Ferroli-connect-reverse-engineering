...
final class zzb {
    ...
    public final boolean zzas() {
        ...
        if (!((KeyguardManager) this.zzag.getSystemService("keyguard")).inKeyguardRestrictedInputMode()) {
            ...
            List<ActivityManager.RunningAppProcessInfo> runningAppProcesses = ((ActivityManager) this.zzag.getSystemService(AgooConstants.OPEN_ACTIIVTY_NAME)).getRunningAppProcesses();
        ...
        NotificationCompat.Builder builder = zzf.zzea;
        if (zzo != null) {
            try {
