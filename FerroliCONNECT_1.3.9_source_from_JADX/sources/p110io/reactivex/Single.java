...
import p110io.reactivex.internal.observers.BiConsumerSingleObserver;
import p110io.reactivex.internal.observers.BlockingMultiObserver;
import p110io.reactivex.internal.observers.ConsumerSingleObserver;
import p110io.reactivex.internal.observers.FutureSingleObserver;
import p110io.reactivex.internal.operators.completable.CompletableFromSingle;
import p110io.reactivex.internal.operators.completable.CompletableToFlowable;
...
import p110io.reactivex.internal.operators.maybe.MaybeFilterSingle;
...
import p110io.reactivex.internal.operators.single.SingleAmb;
import p110io.reactivex.internal.operators.single.SingleCache;
import p110io.reactivex.internal.operators.single.SingleContains;
import p110io.reactivex.internal.operators.single.SingleCreate;
import p110io.reactivex.internal.operators.single.SingleDefer;
import p110io.reactivex.internal.operators.single.SingleDelay;
import p110io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p110io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p110io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p110io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p110io.reactivex.internal.operators.single.SingleDetach;
import p110io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p110io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p110io.reactivex.internal.operators.single.SingleDoFinally;
import p110io.reactivex.internal.operators.single.SingleDoOnDispose;
import p110io.reactivex.internal.operators.single.SingleDoOnError;
import p110io.reactivex.internal.operators.single.SingleDoOnEvent;
import p110io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p110io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p110io.reactivex.internal.operators.single.SingleEquals;
import p110io.reactivex.internal.operators.single.SingleError;
import p110io.reactivex.internal.operators.single.SingleFlatMap;
import p110io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p110io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p110io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p110io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p110io.reactivex.internal.operators.single.SingleFromCallable;
import p110io.reactivex.internal.operators.single.SingleFromPublisher;
import p110io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p110io.reactivex.internal.operators.single.SingleHide;
import p110io.reactivex.internal.operators.single.SingleInternalHelper;
import p110io.reactivex.internal.operators.single.SingleJust;
import p110io.reactivex.internal.operators.single.SingleLift;
import p110io.reactivex.internal.operators.single.SingleMap;
import p110io.reactivex.internal.operators.single.SingleNever;
import p110io.reactivex.internal.operators.single.SingleObserveOn;
import p110io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p110io.reactivex.internal.operators.single.SingleResumeNext;
import p110io.reactivex.internal.operators.single.SingleSubscribeOn;
import p110io.reactivex.internal.operators.single.SingleTakeUntil;
import p110io.reactivex.internal.operators.single.SingleTimeout;
import p110io.reactivex.internal.operators.single.SingleTimer;
import p110io.reactivex.internal.operators.single.SingleToFlowable;
import p110io.reactivex.internal.operators.single.SingleToObservable;
import p110io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p110io.reactivex.internal.operators.single.SingleUsing;
import p110io.reactivex.internal.operators.single.SingleZipArray;
import p110io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo21019as(@NonNull SingleConverter<T, ? extends R> singleConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo21090to(Function<? super Single<T>, R> function) {
        try {
