...
import p110io.reactivex.internal.observers.InnerQueuedObserver;
import p110io.reactivex.internal.observers.InnerQueuedObserverSupport;
...
public final class ObservableConcatMapEager<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class ConcatMapEagerMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable, InnerQueuedObserverSupport<R> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f3855d, disposable)) {
                this.f3855d = disposable;
