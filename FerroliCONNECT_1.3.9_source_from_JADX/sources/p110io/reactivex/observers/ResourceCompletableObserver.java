...
public abstract class ResourceCompletableObserver implements CompletableObserver, Disposable {
    ...
    /* renamed from: s */
    private final AtomicReference<Disposable> f4025s = new AtomicReference<>();
    ...
    public final void onSubscribe(@NonNull Disposable disposable) {
        if (EndConsumerHelper.setOnce(this.f4025s, disposable, getClass())) {
            onStart();
        }
    }

    public final void dispose() {
        if (DisposableHelper.dispose(this.f4025s)) {
            this.resources.dispose();
        }
    }

    public final boolean isDisposed() {
        return DisposableHelper.isDisposed(this.f4025s.get());
    }
}
