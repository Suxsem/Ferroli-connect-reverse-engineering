...
public class StatisticData implements Serializable, Cloneable {
    ...
    public void filledBy(RequestStatistic requestStatistic) {
        if (requestStatistic != null) {
            ...
            if (!(requestStatistic.f408ip == null || requestStatistic.port == 0)) {
                this.ip_port = String.format("%s:%d", new Object[]{requestStatistic.f408ip, Integer.valueOf(requestStatistic.port)});
            }
            ...
            this.dataSpeed = j != 0 ? this.totalSize / j : this.totalSize;
