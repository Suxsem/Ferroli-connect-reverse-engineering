...
public final class HttpUrl {
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C22761.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
    ...
    static /* synthetic */ class C22761 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.HttpUrl.C22761.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public ParseResult parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (schemeDelimiterOffset(str2, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace) != -1) {
                ...
                } else if (!str.regionMatches(true, skipLeadingAsciiWhitespace, URIUtil.HTTP_COLON, 0, 5)) {
