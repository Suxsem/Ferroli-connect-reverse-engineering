...
public final class HttpHeaders {
    ...
    public static boolean hasVaryAll(Headers headers) {
        return varyFields(headers).contains(Constraint.ANY_ROLE);
    }
    ...
    public static boolean hasBody(Response response) {
        ...
        if (((code >= 100 && code < 200) || code == 204 || code == 304) && contentLength(response) == -1 && !HttpHeaderValues.CHUNKED.equalsIgnoreCase(response.header(org.eclipse.jetty.http.HttpHeaders.TRANSFER_ENCODING))) {
            return false;
        }
        return true;
    }
