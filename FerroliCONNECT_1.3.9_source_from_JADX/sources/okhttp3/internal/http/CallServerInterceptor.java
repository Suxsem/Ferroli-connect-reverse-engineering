...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (HttpHeaderValues.CLOSE.equalsIgnoreCase(response.request().header(HttpHeaders.CONNECTION)) || HttpHeaderValues.CLOSE.equalsIgnoreCase(response.header(HttpHeaders.CONNECTION))) {
            streamAllocation.noNewStreams();
        }
