...
public class C0479a implements IAppMonitor {

    /* renamed from: a */
    private static boolean f154a = false;

    /* renamed from: b */
    private static Map<Class<?>, List<Field>> f155b = new ConcurrentHashMap();

    /* renamed from: c */
    private static Map<Class<?>, List<Field>> f156c = new ConcurrentHashMap();

    /* renamed from: d */
    private static Map<Field, String> f157d = new ConcurrentHashMap();

    /* renamed from: e */
    private static Random f158e = new Random();

    /* renamed from: f */
    private static Set<Class<?>> f159f = Collections.newSetFromMap(new ConcurrentHashMap());
                ...
                if (statObject.beforeCommit()) {
                    if (monitor.monitorPoint().equals("network")) {
                        ...
                        if (requestStatisticSampleRate > 10000 || requestStatisticSampleRate < 0) {
                            requestStatisticSampleRate = RestConstants.G_MAX_CONNECTION_TIME_OUT;
                        }
                        if (requestStatisticSampleRate != 10000 && f158e.nextInt(RestConstants.G_MAX_CONNECTION_TIME_OUT) >= requestStatisticSampleRate) {
                            return;
                        }
                    }
                    try {
                        ...
                        List<Field> list = f155b.get(cls);
                        HashMap hashMap = ALog.isPrintLog(1) ? new HashMap() : null;
                        if (list != null) {
                            for (Field field : list) {
                                Object obj = field.get(statObject);
                                create.setValue(f157d.get(field), obj == null ? "" : obj.toString());
                            }
                            for (Field field2 : f156c.get(cls)) {
                                Double valueOf = Double.valueOf(field2.getDouble(statObject));
                                create2.setValue(f157d.get(field2), valueOf.doubleValue());
                                if (hashMap != null) {
                                    hashMap.put(f157d.get(field2), valueOf);
                                }
                            }
                        }
                        AppMonitor.Stat.commit(monitor.module(), monitor.monitorPoint(), create, create2);
                        if (ALog.isPrintLog(1)) {
                            ALog.m325d("awcn.DefaultAppMonitor", "commit stat: " + monitor.monitorPoint(), (String) null, "\nDimensions", create.getMap().toString(), "\nMeasures", hashMap.toString());
                        }
                    } catch (Throwable th) {
                        ALog.m326e("awcn.DefaultAppMonitor", "commit monitor point failed", (String) null, th, new Object[0]);
                    }
                }
            }
        }
    ...
    public void commitAlarm(AlarmObject alarmObject) {
        if (f154a && alarmObject != null && !TextUtils.isEmpty(alarmObject.module) && !TextUtils.isEmpty(alarmObject.modulePoint)) {
            if (ALog.isPrintLog(1)) {
                ALog.m325d("awcn.DefaultAppMonitor", "commit alarm: " + alarmObject, (String) null, new Object[0]);
            }
    ...
    public void commitCount(CountObject countObject) {
        if (f154a && countObject != null && !TextUtils.isEmpty(countObject.module) && !TextUtils.isEmpty(countObject.modulePoint)) {
            if (ALog.isPrintLog(2)) {
                ALog.m328i("awcn.DefaultAppMonitor", "commit count: " + countObject, (String) null, new Object[0]);
            }
    ...
    public synchronized void mo8722a(java.lang.Class<?> r17) {
        /*
            r16 = this;
            r0 = r17
            monitor-enter(r16)
            if (r0 == 0) goto L_0x00f7
            boolean r1 = f154a     // Catch:{ all -> 0x00f4 }
            if (r1 != 0) goto L_0x000b
            goto L_0x00f7
        L_0x000b:
            r1 = 0
            java.util.Set<java.lang.Class<?>> r2 = f159f     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x0064:
            java.util.Map<java.lang.reflect.Field, java.lang.String> r11 = f157d     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x008e:
            java.lang.String r11 = r10.name()     // Catch:{ Exception -> 0x00e7 }
        L_0x0092:
            java.util.Map<java.lang.reflect.Field, java.lang.String> r12 = f157d     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x00c8:
            ...
            goto L_0x0039
        L_0x00cc:
            java.util.Map<java.lang.Class<?>, java.util.List<java.lang.reflect.Field>> r3 = f155b     // Catch:{ Exception -> 0x00e7 }
            r3.put(r0, r4)     // Catch:{ Exception -> 0x00e7 }
            java.util.Map<java.lang.Class<?>, java.util.List<java.lang.reflect.Field>> r3 = f156c     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x00e7:
            ...
            anet.channel.util.ALog.m326e(r2, r3, r4, r0, r1)     // Catch:{ all -> 0x00f4 }
        L_0x00f2:
            monitor-exit(r16)
            return
        L_0x00f4:
        ...
        L_0x00f7:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: anet.channel.appmonitor.C0479a.mo8722a(java.lang.Class):void");
    }
}
