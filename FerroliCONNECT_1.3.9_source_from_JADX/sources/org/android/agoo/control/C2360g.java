...
class C2360g implements Runnable {
    ...
    /* renamed from: c */
    final /* synthetic */ AgooFactory f4085c;

    C2360g(AgooFactory agooFactory, String str, String str2) {
        this.f4085c = agooFactory;
        this.f4083a = str;
        this.f4084b = str2;
    }
    ...
    public void run() {
        /*
            ...
            r6 = 1
            java.lang.String r7 = r8.f4083a     // Catch:{ Throwable -> 0x0065 }
            r5[r6] = r7     // Catch:{ Throwable -> 0x0065 }
            r6 = 2
            java.lang.String r7 = "extData"
            r5[r6] = r7     // Catch:{ Throwable -> 0x0065 }
            r6 = 3
            java.lang.String r7 = r8.f4084b     // Catch:{ Throwable -> 0x0065 }
            r5[r6] = r7     // Catch:{ Throwable -> 0x0065 }
            com.taobao.accs.utl.ALog.m3728i(r1, r4, r5)     // Catch:{ Throwable -> 0x0065 }
        L_0x0029:
            java.lang.String r4 = "accs"
            java.lang.String r5 = r8.f4083a     // Catch:{ Throwable -> 0x0065 }
        ...
        L_0x003b:
            ...
            java.lang.String r3 = r8.f4083a     // Catch:{ Throwable -> 0x0060, all -> 0x005d }
            r5.msgIds = r3     // Catch:{ Throwable -> 0x0060, all -> 0x005d }
            java.lang.String r3 = r8.f4084b     // Catch:{ Throwable -> 0x0060, all -> 0x005d }
            ...
            org.android.agoo.control.AgooFactory r3 = r8.f4085c     // Catch:{ Throwable -> 0x0060, all -> 0x005d }
            java.lang.String r4 = r8.f4083a     // Catch:{ Throwable -> 0x0060, all -> 0x005d }
            r3.updateMsgStatus(r4, r0)     // Catch:{ Throwable -> 0x0060, all -> 0x005d }
            org.android.agoo.control.AgooFactory r0 = r8.f4085c
        ...
        L_0x0088:
            ...
            org.android.agoo.control.AgooFactory r1 = r8.f4085c
            org.android.agoo.control.NotifManager r1 = r1.notifyManager
            r1.reportNotifyMessage(r3)
        L_0x0093:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.android.agoo.control.C2360g.run():void");
    }
}
