    ...
    private class FormattingVisitor implements NodeVisitor {
        ...
        public void head(Node node, int i) {
            ...
            if (node instanceof TextNode) {
                ...
                append("  ");
            } else if (StringUtil.m3922in(nodeName, "p", "h1", "h2", "h3", "h4", "h5", LanguageUtil.LOGOGRAM_TR)) {
                append("\n");
            }
        }
        ...
        public void tail(Node node, int i) {
            String nodeName = node.nodeName();
            if (StringUtil.m3922in(nodeName, "br", "dd", "dt", "p", "h1", "h2", "h3", "h4", "h5")) {
                append("\n");
        ...
        private void append(String str) {
            ...
            if (str.equals(" ")) {
                if (this.accum.length() != 0) {
                    ...
                    if (StringUtil.m3922in(sb.substring(sb.length() - 1), " ", "\n")) {
                        return;
                    }
                } else {
                    return;
