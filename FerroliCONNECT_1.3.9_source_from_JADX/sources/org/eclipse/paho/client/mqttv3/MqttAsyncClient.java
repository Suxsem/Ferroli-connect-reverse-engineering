...
public class MqttAsyncClient implements IMqttAsyncClient {
    ...
    public IMqttToken disconnect(long j, Object obj, IMqttActionListener iMqttActionListener) throws MqttException {
        ...
        try {
            ...
            log.fine(CLASS_NAME, MqttServiceConstants.DISCONNECT_ACTION, "105", (Object[]) null, e);
            throw e;
        }
    }
    ...
    public void attemptReconnect() {
        ...
        try {
            ...
            log.fine(CLASS_NAME, "attemptReconnect", "804", (Object[]) null, e);
        } catch (MqttException e2) {
            log.fine(CLASS_NAME, "attemptReconnect", "804", (Object[]) null, e2);
        }
    }
    ...
    public void close(boolean z) throws MqttException {
        log.fine(CLASS_NAME, HttpHeaderValues.CLOSE, "113");
        this.comms.close(z);
        log.fine(CLASS_NAME, HttpHeaderValues.CLOSE, "114");
    }
