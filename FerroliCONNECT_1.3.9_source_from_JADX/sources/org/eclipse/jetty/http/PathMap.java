...
public class PathMap extends HashMap implements Externalizable {
    ...
    public Object getLazyMatches(String str) {
        Object obj = null;
        if (str == null) {
            return LazyList.getList((Object) null);
        }
        int length = str.length();
        int i = 0;
        Map.Entry entry = this._exactMap.getEntry(str, 0, length);
        if (entry != null) {
            obj = LazyList.add((Object) null, entry.getValue());
        }
        int i2 = length - 1;
        while (true) {
            i2 = str.lastIndexOf(47, i2 - 1);
    ...
    private static boolean isPathWildcardMatch(String str, String str2) {
        ...
        if (!str.endsWith("/*") || !str2.regionMatches(0, str, 0, length) || (str2.length() != length && '/' != str2.charAt(length))) {
            return false;
        }
        return true;
    }
