...
public class StatisticsServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        if (childHandlerByClass != null) {
            ...
            if (getInitParameter("restrictToLocalhost") != null) {
                this._restrictToLocalhost = RequestConstant.TRUE.equals(getInitParameter("restrictToLocalhost"));
                return;
            }
            return;
        }
    ...
    public void doGet(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        } else if (!this._restrictToLocalhost || isLoopbackAddress(httpServletRequest.getRemoteAddr())) {
            String parameter = httpServletRequest.getParameter("xml");
            if (parameter == null) {
                parameter = httpServletRequest.getParameter("XML");
            }
            if (parameter == null || !RequestConstant.TRUE.equalsIgnoreCase(parameter)) {
    ...
    private boolean isLoopbackAddress(String str) {
        try {
            ...
            Logger logger = LOG;
            logger.warn("Warning: attempt to access statistics servlet from " + str, (Throwable) e);
            return false;
        }
    }
