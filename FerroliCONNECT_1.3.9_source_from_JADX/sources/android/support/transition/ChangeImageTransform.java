    ...
    static /* synthetic */ class C01263 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.transition.ChangeImageTransform.C01263.<clinit>():void");
        }
    }

    private static Matrix copyImageMatrix(ImageView imageView) {
        int i = C01263.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
        if (i == 1) {
