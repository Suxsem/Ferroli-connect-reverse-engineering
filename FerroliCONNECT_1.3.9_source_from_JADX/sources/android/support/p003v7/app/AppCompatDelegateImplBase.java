...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                private boolean shouldWrapException(Throwable th) {
                    ...
                    if (message.contains(CustomNotificationBuilder.NOTIFICATION_ICON_RES_TYPE) || message.contains("Drawable")) {
                        return true;
                    }
                    return false;
                }
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0359R.attr.homeAsUpIndicator});
