...
class TwilightManager {
    ...
    static TwilightManager getInstance(@NonNull Context context) {
        if (sInstance == null) {
            ...
            sInstance = new TwilightManager(applicationContext, (LocationManager) applicationContext.getSystemService(Constant.WEATHER_LOCATION));
        }
        return sInstance;
    }
    ...
    private void updateState(@NonNull Location location) {
        ...
        long j6 = j3;
        boolean z2 = z;
        instance.calculateTwilight(Constants.CLIENT_FLUSH_INTERVAL + currentTimeMillis, location.getLatitude(), location.getLongitude());
