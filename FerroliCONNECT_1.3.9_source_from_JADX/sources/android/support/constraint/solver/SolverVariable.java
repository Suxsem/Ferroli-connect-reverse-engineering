...
public class SolverVariable {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C00181.$SwitchMap$android$support$constraint$solver$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C00181 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.constraint.solver.SolverVariable.C00181.<clinit>():void");
        }
    }
