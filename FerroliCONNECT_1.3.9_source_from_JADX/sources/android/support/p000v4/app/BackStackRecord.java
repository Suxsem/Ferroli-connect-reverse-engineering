...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    String mName;
    ArrayList<C0169Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0169Op {
        ...
        C0169Op(int i, Fragment fragment2) {
            this.cmd = i;
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0169Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0169Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0169Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0169Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0169Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0169Op(8, fragment));
        return this;
    }
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0169Op op2 = backStackRecord.mOps.get(i7);
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment5.mContainerId == i3) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i4, new C0169Op(9, fragment5));
                                    i4++;
                                    fragment4 = null;
                                }
                                C0169Op op2 = new C0169Op(3, fragment5);
                    ...
                    if (op.fragment == fragment2) {
                        this.mOps.add(i, new C0169Op(9, op.fragment));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new C0169Op(9, fragment2));
                        i++;
    ...
    private static boolean isFragmentPostponed(C0169Op op) {
        Fragment fragment = op.fragment;
