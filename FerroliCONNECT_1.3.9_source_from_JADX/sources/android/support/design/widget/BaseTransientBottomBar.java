...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull ContentViewCallback contentViewCallback) {
        if (viewGroup == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0030R.C0033layout.design_layout_snackbar, this.mTargetParent, false);
    ...
    public void animateViewIn() {
        ...
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0030R.anim.design_snackbar_in);
    ...
    private void animateViewOut(final int i) {
        ...
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0030R.anim.design_snackbar_out);
        loadAnimation.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        loadAnimation.setDuration(250);
        loadAnimation.setAnimationListener(new Animation.AnimationListener() {
            public void onAnimationRepeat(Animation animation) {
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(C0030R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C0030R.styleable.SnackbarLayout_elevation, 0));
            }
