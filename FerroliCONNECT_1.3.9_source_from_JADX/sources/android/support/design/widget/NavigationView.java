...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0030R.styleable.NavigationView, i, C0030R.style.Widget_Design_NavigationView);
        ...
        if (obtainStyledAttributes.hasValue(C0030R.styleable.NavigationView_itemIconTint)) {
            colorStateList = obtainStyledAttributes.getColorStateList(C0030R.styleable.NavigationView_itemIconTint);
        } else {
        ...
        ColorStateList colorStateList2 = obtainStyledAttributes.hasValue(C0030R.styleable.NavigationView_itemTextColor) ? obtainStyledAttributes.getColorStateList(C0030R.styleable.NavigationView_itemTextColor) : null;
