...
class FloatingActionButtonLollipop extends FloatingActionButtonImpl {
    ...
    public void onElevationsChanged(float f, float f2) {
        ...
        if (Build.VERSION.SDK_INT != 21) {
            ...
            animatorSet.play(ObjectAnimator.ofFloat(this.mView, "elevation", new float[]{f3}).setDuration(0)).with(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, new float[]{f4}).setDuration(100));
            animatorSet.setInterpolator(ANIM_INTERPOLATOR);
            stateListAnimator.addState(PRESSED_ENABLED_STATE_SET, animatorSet);
            AnimatorSet animatorSet2 = new AnimatorSet();
            animatorSet2.play(ObjectAnimator.ofFloat(this.mView, "elevation", new float[]{f3}).setDuration(0)).with(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, new float[]{f4}).setDuration(100));
            ...
            arrayList.add(ObjectAnimator.ofFloat(this.mView, "elevation", new float[]{f3}).setDuration(0));
